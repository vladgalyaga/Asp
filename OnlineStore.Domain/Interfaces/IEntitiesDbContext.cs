...
namespace OnlineStore.Domain.Interfaces
{
    public interface IEntitiesDbContext : ISaveable, IDisposable
    {
        ...
        /// <returns></returns>
        bool IsSetExist<TEntity>() where TEntity : class, IKeyable;
        ...
        /// <returns></returns>
        IDbSet<TEntity> TryGetSet<TEntity>() where TEntity : class, IKeyable;
        ...
        void CreateEntity<TEntity>(TEntity entity) where TEntity : class, IKeyable;
        /// <summary>
        ...
        void UpdateEntity<TEntity>(TEntity entity) where TEntity : class, IKeyable;
        /// <summary>
        ...
        void RemoveEntity<TEntity>(TEntity entity) where TEntity : class, IKeyable;
    }
}
