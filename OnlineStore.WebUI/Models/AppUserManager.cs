...
namespace OnlineStore.WebUI.Models
{
    public class AppUserManager : UserManager<Users, int>
    {
        ...
        {
            var manager = new AppUserManager(new UserStore<Users, Roles, int, Logins, UserRole, UserClaims>(context.Get<NorthwindDbContext>()));
            ...
            //manager.RegisterTwoFactorProvider("Код, полученный по телефону", new PhoneNumberTokenProvider<Users, int>
            //{
            //    MessageFormat = "Ваш код безопасности: {0}"
            //});
            //manager.RegisterTwoFactorProvider("Код из сообщения", new EmailTokenProvider<Users, int>
            //{
